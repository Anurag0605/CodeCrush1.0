...
$sql = "SELECT * FROM farmers.signup WHERE name='$name' AND password='$pass'";
        ...
        <div class="container py-5 h-100">
          <div class="row d-flex align-items-center justify-content-center h-100">
            <div class="col-md-8 col-lg-7 col-xl-6">
              <img src="https://cdni.iconscout.com/illustration/premium/thumb/farmers-use-smart-devices-to-grow-their-plants-7623340-6158463.png?f=webp"
